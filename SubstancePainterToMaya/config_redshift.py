...
class config:
    ...
    def __init__(self):
        self.MAP_LIST = [
            '0---- Choose', 'diffuse', 'height', 'metalness', 'normal', 'specRoughness',
            '6---- Diffuse', 'diffuse_color', 'diffuse_weight', 'diffuse_roughness',
            '10----  Back - lighting / Translucency', 'transl_color', 'transl_weight',
            '13---- Reflection', 'refl_color', 'refl_weight', 'refl_roughness', 'refl_aniso', 'refl_aniso_rotation',
            ...
            '30---- Refraction / Transmission', 'refr_color', 'refr_weight', 'refr_abbe',
            '34---- Sub - Surface', 'refr_transmittance', 'refr_absorption_scale', 'ss_scatter_coeff', 'ss_amount',
            '39---- Multiple Scattering', 'ms_amount', 'ms_color0', 'ms_weight0', 'ms_radius0', 'ms_color1', 'ms_weight1', 'ms_radius1', 'ms_color2', 'ms_weight2', 'ms_radius2',
            '50---- Coating', 'coat_color', 'coat_weight', 'coat_roughness', 'coat_samples', 'coat_ior30', 'coat_ior31', 'coat_ior32',
            'coat_reflectivity', 'coat_ior', 'coat_transmittance', 'coat_thickness', 'coat_bump_input',
            '64---- Overall', 'overall_color', 'opacity_color', 'emission_color', 'emission_weight', 'bump_input',
            '69---- Don\'t use'
        ]
        ...
        self.MAP_LIST_COLOR_ATTRIBUTES_INDICES = [1, 4, 7, 11, 14, 25, 26, 27, 31, 35, 37, 41, 44, 47, 51, 58, 60, 65, 66, 67, 69]
        self.DONT_USE_IDS = [0, 6, 10, 13, 30, 34, 39, 50, 64, 70]
